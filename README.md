...
data/
  ...
  images/                 # raw downloaded images by region
  dataset/                # symlink tree (train/ test/)
  sample_metadata.csv
...
models/
  geoclassifier-v1-fp16.onnx
  confusion_matrix_table.table.json   # W&B confusion matrix export (test set)
